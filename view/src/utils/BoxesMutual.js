    ...
    return(
        ...
        <Paper className={classes.box}  >
            ...
            <p style={{position: 'relative',top: '-1.5vh'}}>
                 <b className={classes.value} >Abs. : {dataM.data?dataM.data.hybrid?(dataM.data.hybrid.pop()).toFixed(2):'':''} </b>
                %  <br/>
        ...
        <Paper className={classes.box}  >
            Mag. Eq. ESG
            <p style={{position: 'relative',top: '-1.5vh'}}>
                 <b className={classes.value} >Abs. : {dataM.data?dataM.data.hybrid?(dataM.data.magEquity.pop()).toFixed(2):'':''} </b>
                %  <br/>
        ...
        <Paper className={classes.box}  >
            Mag. Midcap
            <p style={{position: 'relative',top: '-1.5vh'}}>
                 <b className={classes.value} >Abs. : {dataM.data?dataM.data.magMidcap?(dataM.data.magMidcap.pop()).toFixed(2):'':''} </b>
                %  <br/>
        ...
        <Paper className={classes.box}  >
            Smallcap
            <p style={{position: 'relative',top: '-1.5vh'}}>
                 <b className={classes.value} >Abs. : {dataM.data?dataM.data.smallcap?(dataM.data.smallcap.pop()).toFixed(2):'':''} </b>
                %  <br/>
        ...
        <Paper className={classes.box}  >
            Focused Equity
            <p style={{position: 'relative',top: '-1.5vh'}}>
                 <b className={classes.value} >Abs. : {dataM.data?dataM.data.focused?(dataM.data.focused.pop()).toFixed(2):'':''} </b>
                %  <br/>
        ...
        <Paper className={classes.box}  >
            Large Cap
            <p style={{position: 'relative',top: '-1.5vh'}}>
                 <b className={classes.value} >Abs. : {dataM.data?dataM.data.large?(dataM.data.large.pop()).toFixed(2):'':''} </b>
                %  <br/>
